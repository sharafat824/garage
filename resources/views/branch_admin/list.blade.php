        ...
        <table id="supplier" class="table jambo_table" style="width:100%">
          ...
          <tbody>
            ...
            @endcan
              ...
              <td><a href="{!! url('/branchadmin/list/' . $branchadmin->id) !!}">{{ getBranchName($branchadmin->branch_id) }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Branch" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $branchadmin->name }} <a data-toggle="tooltip" data-placement="bottom" title="First Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $branchadmin->lastname }} <a data-toggle="tooltip" data-placement="bottom" title="Last Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $branchadmin->email }} <a data-toggle="tooltip" data-placement="bottom" title="Email" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $branchadmin->mobile_no }} <a data-toggle="tooltip" data-placement="bottom" title="Mobile Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
