    ...
    <div class="page-title">
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{{ URL::previous() }}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}"></i><span class="titleup" style="margin-right: 4px;"> {{ trans('message.Edit Branch Admin') }}</span>
            </a>
          </div>
            ...
            <div class="row">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 gender">
                  ...
                  <input type="radio" name="gender" value="0" <?php if ($branchadmin->gender == 0) {
                                                                echo 'checked';
                                                              } ?> checked> {{ trans('message.Male') }}

                  <input type="radio" name="gender" value="1" <?php if ($branchadmin->gender == 1) {
                                                                echo 'checked';
