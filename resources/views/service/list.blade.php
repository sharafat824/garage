                    ...
                    <table id="supplier" class="table jambo_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr data-user-id="{{ $services->id }}">
                                ...
                                @endcan
                                <td><a data-bs-toggle="modal" data-bs-target="#myModal" serviceid="{{ $services->id }}" url="{!! url('/service/list/view') !!}" class="save">{{ $services->job_no }} <a data-toggle="tooltip" data-placement="bottom" title="Job No" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                                <td><a data-bs-toggle="modal" data-bs-target="#myModal" serviceid="{{ $services->id }}" url="{!! url('/service/list/view') !!}" class="save">{{ getCustomerName($services->customer_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                                <?php $date_db = date('Y-m-d', strtotime($services->service_date)); ?>
                                @if (!empty($current_month) && strpos($available, $date_db) !== false)
                                <td><span class="label label-danger" style="font-size:13px;">{{ date(getDateFormat(), strtotime($date_db)) }} <a data-toggle="tooltip" data-placement="bottom" title="Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></span>
                                </td>
                                @else
                                <td> {{ date(getDateFormat(), strtotime($date_db)) }} <a data-toggle="tooltip" data-placement="bottom" title="Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                @endif
                                <td>{{ $services->service_category }} <a data-toggle="tooltip" data-placement="bottom" title="Service Category" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>{{ getAssignTo($services->assign_to) }} <a data-toggle="tooltip" data-placement="bottom" title="Assign To" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                ...
                                @endif -->
                                <td>{{ getVehicleNumberPlate($services->vehicle_id) ?? trans('message.Not Added') }} <a data-toggle="tooltip" data-placement="bottom" title="Number Plate" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>
