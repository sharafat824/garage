                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="text" id="date_of_birth" autocomplete="off" name="out_date" class="form-control datepicker" placeholder="<?php echo getDatepicker();
                                                                                                                                                                echo ' hh:mm:ss'; ?>" onkeypress="return false;" value="{{ old('date', now()->format('Y-m-d H:i:s')) }}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h6 class="panel-title">
                                        <a class="observation_Plus" data-bs-toggle="collapse" href="#collapse2" role="button" aria-expanded="true" aria-controls="collapseExample">
