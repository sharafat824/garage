        ...
        <table id="supplier" class=" table jumbo_table " style="width:100%">
          ...
          <tbody>
            ...
            <tr data-user-id="{{ $users->id }}">
              ...
              <td>{{ substr(getProductList($users->id), 0, 100) }} <a data-toggle="tooltip" data-placement="bottom" title="Product Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
