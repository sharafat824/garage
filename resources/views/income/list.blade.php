                    ...
                    <table id="supplier" class="table jambo_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr data-user-id="{{ $incomes->id }}">
                                ...
                                @endcan
                                <td><a href="{!! url('/income/edit/' . $incomes->tbl_income_id) !!}">{{ getCustomerName($incomes->customer_id) }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td><a href="{!! url('/income/edit/' . $incomes->tbl_income_id) !!}">{{ $incomes->invoice_number }} </a><a data-toggle="tooltip" data-placement="bottom" title="Invoice Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>{{ number_format(getSumOfIncome($incomes->tbl_income_id), 2) }} <a data-toggle="tooltip" data-placement="bottom" title="Amount(<?php echo getCurrencySymbols(); ?>)" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>{{ GetPaymentMethod($incomes->payment_type) }} <a data-toggle="tooltip" data-placement="bottom" title="Payment Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>{{ date(getDateFormat(), strtotime($incomes->date)) }} <a data-toggle="tooltip" data-placement="bottom" title="Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>{{ $incomes->main_label }} <a data-toggle="tooltip" data-placement="bottom" title="Main Label" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
