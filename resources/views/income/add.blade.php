      ...
      <div class="x_panel">
        <div class="x_content">
          <form method="post" id="addIncomeForm" action="{{ url('/income/store') }}" enctype="multipart/form-data" class="form-horizontal upperform addIncomeForm" id="add-income-form">
            ...
            <div class="row form-group my-form-group">
            ...
            <div class="row form-group">
              ...
              <div class="row col-md-6 col-sm-6 col-xs-12 form-group my-form-group paymentTypeMainDiv">
            ...
            <div class="items row">
              <div class="row form-group">
                <div class="row col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('income_entry[]') ? ' has-error' : '' }}">
