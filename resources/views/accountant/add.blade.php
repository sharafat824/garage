    ...
    <div class="page-title">
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/accountant/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}"></i><span class="titleup">
        ...
        <div class="x_content">
          <form id="accountant_add_form" action="{!! url('/accountant/store') !!}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask accountantAddForm">
            ...
            <div class="row">
              ...
              <div class="row col-md-6 col-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <div class="row">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6  my-form-group has-feedback">
                ...
                <div class="col-md-8 col-lg-12 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
