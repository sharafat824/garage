      ...
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup">{{ trans('message.Accountant') }}
              @can('accountant_add')
              <a href="{!! url('/accountant/add') !!}" id=""><img src="{{ URL::asset('public/img/icons/plus Button.png') }}">
              </a>
              @endcan
            </span>
          </div>
        ...
        <table id="supplier" class="table jambo_table" style="width:100%">
          ...
          <tbody>
            ...
            @endcan
              ...
              <td><a href="{!! url('/accountant/list/' . $accountants->id) !!}">{{ $accountants->name }}</a> <a data-toggle="tooltip" data-placement="bottom" title="First Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $accountants->lastname }} <a data-toggle="tooltip" data-placement="bottom" title="Last Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $accountants->email }} <a data-toggle="tooltip" data-placement="bottom" title="Email" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $accountants->mobile_no }} <a data-toggle="tooltip" data-placement="bottom" title="Mobile Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              ...
              <td>
                <div class="dropdown_toggle">
                  ...
                  <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                    ...
                    <li><a class="dropdown-item sa-warning" url="{!! url('/accountant/list/delete/' . $accountants->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                    @endcan
                  </ul>
                </div>
              </td>
