...
// Fallback for REQUEST_SCHEME if not set
...
// Get the current route without the base URL
    ...
    <div class="main_container">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li class={{in_array($currentRoute,$inventoryRoutes) ? 'active' : ''}}><a href="{!! url('/') !!}"><i class="fa-solid fa-house"></i>&nbsp;&nbsp;&nbsp; {{ trans('message.Dashboard') }}
                  </a></li>
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/supplier/list/') || Str::startsWith($currentRoute, '/product/list/edit/') || Str::startsWith($currentRoute, '/purchase/list/edit/') ? 'active' : '' }}">
                  ...
                  <div class="dropdown">
                    <a href="#"><i class="fa-solid fa-sliders"></i>{{ trans('message.Inventory') }}<span class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/customer/list/') || Str::startsWith($currentRoute, '/employee/view/') || Str::startsWith($currentRoute, '/employee/edit/') || Str::startsWith($currentRoute, '/supportstaff/list/') || Str::startsWith($currentRoute, '/accountant/list/') || Str::startsWith($currentRoute, '/branchadmin/list/') ? 'active' : '' }}">
                  ...
                  <div class="dropdown">
                    <a href="#"><i class="fa-regular fa-user"></i>&nbsp;&nbsp;{{ trans('message.Users') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/vehicle/list') || Str::startsWith($currentRoute, '/vehicletype/list/') || Str::startsWith($currentRoute, '/vehiclebrand/list/') || Str::startsWith($currentRoute, '/color/list/edit/') ? 'active' : '' }}">
                  ...
                  <div class="dropdown">
                    <a href="#"><i class="fa-solid fa-car-side"></i>{{ trans('message.Vehicles') }}&nbsp;&nbsp;<span class="fa fa-chevron-right dropdown-right-icon icon"> </span></a>
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/quotation/list/') ? 'active' : '' }}">
                  <a href="{!! url('/quotation/list') !!}"><i class="fa-solid fa-file-invoice-dollar"></i>&nbsp;&nbsp;&nbsp; {{ trans('message.Quotation') }}
                  </a>
                </li>
                @endcan
                ...
                @endphp
                @can('invoice_view')
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/invoice/') ? 'active' : '' }}"><a href="{!! url('/invoice/list') !!}"><i class="fa-solid fa-receipt"></i>{{ trans('message.Invoices') }}</a></li>
                @endcan
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/jobcard/') || Str::startsWith($currentRoute, '/gatepass/') ? 'active' : '' }}">
                  <div class="dropdown">
                    <a href="#"><i class="fa-solid fa-credit-card"></i>{{ trans('message.Job Card') }}<span class="fa fa-chevron-right dropdown-right-icon icon"></span></a>
                ...
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/taxrates/') || Str::startsWith($currentRoute, '/payment/') || Str::startsWith($currentRoute, '/income/') || Str::startsWith($currentRoute, '/expense/') ? 'active' : '' }}">
                  <div class="dropdown">
                    <a href="#"><i class="fa-solid fa-calculator"></i>{{trans('message.Accounts')}}<span class="fa fa-chevron-right dropdown-right-icon icon"></span></a>
                    <div class="dropdown-content">
                      @can('taxrate_view')
                ...
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/sales_part/') ? 'active' : ''}}"><a href="{!! url('/sales_part/list') !!}"><i class="fa-solid fa-tag"></i>{{ trans('message.Part Sells') }} </a> </li>
                @else
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/sales_part/') ? 'active' : ''}}"><a href="{!! url('/sales_part/list') !!}"><i class="fa-solid fa-tag"></i>{{ trans('message.Purchase') }} </a> </li>
                @endif
                @endcan
                ...
                @endphp
                @can('rto_view')
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/rto/') ?  'active' : ''}}"><a href="{!! url('/rto/list') !!}"><i class="fa-solid fa-clipboard-check"></i>{{ trans('message.Compliance') }}</a>
                </li>
                @endcan
                ...
                @endphp
                @can('report_view')
                <li class="{{in_array($currentRoute,$inventoryRoutes)  || Str::startsWith($currentRoute, '/report/')? 'active' : ''}}"><a href="{!! url('/report/servicereport') !!}"><i class="fa-solid fa-chart-line"></i>&nbsp;&nbsp;&nbsp;{{ trans('message.Reports') }}
                  </a></li>
                @endcan

                @can('emailtemplate_view')
                <li class="w-100"><a href="{!! url('/mail/mail') !!}"><i class="fa-solid fa-envelope-open-text"></i>{{ trans('message.Email Templates') }}</a></li>
                @endcan
                ...
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/setting/custom/') ? 'active' : ''}}"><a href="{!! url('/setting/custom/list') !!}"><i class="fa-solid fa-puzzle-piece"></i>{{ trans('message.Custom Fields') }}</a> </li>
                @endcan
                ...
                <li class="{{in_array($currentRoute,$inventoryRoutes) ? 'active' : ''}}"><a href="{!! url('/observation/list') !!}"><i class="fa-solid fa-file-lines"></i>{{ trans('message.Observation library') }}</a></li>
                @endcan
                ...
                @endphp
                @can('branch_view')
                <li class="{{in_array($currentRoute,$inventoryRoutes) || Str::startsWith($currentRoute, '/branch/') ? 'active' : ''}}"><a href="{!! url('/branch/list') !!}"><i class="fa-solid fa-code-branch"></i>{{ trans('message.Branch') }}
                  </a>
                </li>
                @endcan
                ...
                <li class="{{in_array($currentRoute,$inventoryRoutes) ? 'active' : ''}}"><a data-toggle="" data-placement="top" href="{!! url('/setting/general_setting/list') !!}" title="{{trans('message.Settings')}}"> <i class="fa-solid fa-gear"></i>{{trans('message.Settings')}}</a></li>
                @else
      ...
      <div class="top_nav position-relative">
        ...
        <footer class="footerforallpage bottom-0 bg-white text-center" id="footerforid">
          <span class="footerbottom me-3">{{ trans('© Copyright 2023 | Garage Master  | All Rights Reserved') }}</span>
        </footer>
      </div>
    </div>
  </div>
