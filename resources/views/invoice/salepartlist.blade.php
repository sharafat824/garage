                ...
                @if(!empty($invoice) && count($invoice) > 0)
                    <table id="supplier" class="table jambo_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="texr-left">
                                <!-- <td>{{ $i }}</td> -->
                                <td><button type="button" data-bs-toggle="modal" data-bs-target="#myModal-job" type_id="{{ $invoices->type }}" serviceid="{{ $invoices->sales_service_id }}" auto_id="{{ $invoices->id }}" url="{!! url('/jobcard/modalview') !!}" sale_url="{!! url('/sales_part/list/modal') !!}" class="dropdown-item save">{{ $invoices->invoice_number }} <a data-toggle="tooltip" data-placement="bottom" title="Invoice Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></button></li>
                                <td><button type="button" data-bs-toggle="modal" data-bs-target="#myModal-job" type_id="{{ $invoices->type }}" serviceid="{{ $invoices->sales_service_id }}" auto_id="{{ $invoices->id }}" url="{!! url('/jobcard/modalview') !!}" sale_url="{!! url('/sales_part/list/modal') !!}" class="dropdown-item save">{{ getCustomerName($invoices->customer_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></button></td>
                                @if ($invoices->type == 2)
                                ...
                                <td>{{ number_format($invoices->grand_total, 2) }} <a data-toggle="tooltip" data-placement="bottom" title="Total Amount ({{ getCurrencySymbols() }})" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
