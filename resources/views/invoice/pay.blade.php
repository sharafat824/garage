                        ...
                        <div class="row mt-3">
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                    <input type="text" name="Date" id="date_of_birth" autocomplete="off" class="form-control invoiceDate datepicker" placeholder="<?php echo getDatepicker(); ?>" onkeypress="return false;" required>
                                </div>
                            </div>
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('keyup', '#amountreceived', function() {
            ...
            if (parseFloat(amount) <= parseFloat(dueamount)) {} else {
                swal({
                    title: msg1,
                    text: msg2,
