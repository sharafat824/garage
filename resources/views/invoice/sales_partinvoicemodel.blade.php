...
<body>
    ...
    <div class="">
        ...
        <div class=" modal-footer mpPrintPdfCloseButtonForSmallDevices">
            <button type="button" class="btn btn-outline-secondary btn-sm printbtn mx-2" id="" onclick="PrintElem('sales_print')"><img src="{{ URL('public/img/icons/Print (1).png') }}" class="pdfButton"></button>
            <a href="{{ url('invoice/salespartpdf/' . $invioce->id) }}" class="prints tagAforPdfBtn"><button type="button" class="btn btn-outline-secondary btn-sm pdfButton mx-0" style="margin-left: 15px;"><img src="{{ URL('public/img/icons/PDF.png') }}" class="pdfButton"></button></a>
