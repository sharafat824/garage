                    ...
                    <table id="supplier" class="table table-sm" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr data-user-id="{{ $invoices->id }}">
                                ...
                                @endcan
                                <td><a data-bs-toggle="modal" data-bs-target="#myModal-job" type_id="{{ $invoices->type }}" serviceid="{{ $invoices->sales_service_id }}" job_no="{{$invoices->job_card}}" auto_id="{{ $invoices->id }}" url="{!! url('/jobcard/modalview') !!}" sale_url="{!! url('/sales/list/modal') !!}" class="save">{{ $invoices->invoice_number }} <a data-toggle="tooltip" data-placement="bottom" title="Invoice Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                                <td><a data-bs-toggle="modal" data-bs-target="#myModal-job" type_id="{{ $invoices->type }}" serviceid="{{ $invoices->sales_service_id }}" job_no="{{$invoices->job_card}}" auto_id="{{ $invoices->id }}" url="{!! url('/jobcard/modalview') !!}" sale_url="{!! url('/sales/list/modal') !!}" class="save">{{ getCustomerName($invoices->customer_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                                @if ($invoices->type == 2)
                                <td>{{ trans('message.Part') }} <a data-toggle="tooltip" data-placement="bottom" title="Invoice For" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                @else
                                <td>
                                ...
                                <td><?php $charges = $invoices->grand_total ?>
                                    {{ number_format($charges, 2) }} <a data-toggle="tooltip" data-placement="bottom" title="Total Amount({{ getCurrencySymbols() }})" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
                                </td>
                                <td>{{ number_format($invoices->paid_amount, 2) }} <a data-toggle="tooltip" data-placement="bottom" title="Paid Amount({{ getCurrencySymbols() }})" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>

                                <td>{{ date(getDateFormat(), strtotime($invoices->date)) }} <a data-toggle="tooltip" data-placement="bottom" title="Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                <td>
