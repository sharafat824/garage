...
<div class="row modalfooterline">
    ...
    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 modal-footer mpPrintPdfCloseButtonForSmallDevices mx-2">
        ...
        <a href="{{ url('quotation/quotationpdf/' . $service_data->id) }}" class="prints tagAforPdfBtn"><button type="button" class="btn pdfButton"><img src="{{ URL('public/img/icons/PDF.png') }}" class="pdfButton"></button></a>
