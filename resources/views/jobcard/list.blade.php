          ...
          <table id="supplier" class="table jambo_table" style="width: 100px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $servicess->job_no }} <a data-toggle="tooltip" data-placement="bottom" title="Job Card No." class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>
                  {{ trans('message.' . ucwords($servicess->service_type)) }} <a data-toggle="tooltip" data-placement="bottom" title="Service Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
                </td>
                <td>{{ getCustomerName($servicess->customer_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <?php $dateservice = date('Y-m-d', strtotime($servicess->service_date)); ?>
                @if (strpos($available, $dateservice) !== false)
                <td><span class="label  label-danger" style="font-size:13px;">{{ date(getDateFormat(), strtotime($dateservice)) }} <a data-toggle="tooltip" data-placement="bottom" title="Service Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></span></td>
                @else
                <td>{{ date(getDateFormat(), strtotime($dateservice)) }} <a data-toggle="tooltip" data-placement="bottom" title="Service Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                @endif
                <td>
