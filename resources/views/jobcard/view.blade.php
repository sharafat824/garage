            ...
            <nav>
                <div class="nav toggle">
                    <span class="titleup">
                        ...
                        <a href="{!! url('/jobcard/list') !!}" id=""><i class=""><img
                                    src="{{ URL::asset('public/supplier/Back Arrow.png') }}"></i><span class="titleup">
                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" action="{!! url('/jobcard/store') !!}" class="addJobcardForm">
                                ...
                                <div class="row">
                                    <div class="row col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-sm-7 col-xs-7">
                                        ...
                                        <div class="row col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 garrageadd mt-3"
                                                valign="top">
                                    ...
                                    <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-5 col-xs-5">
                                        <div class="row ">
                                            <label
                                                class="control-label jobcardmargintop col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">{{
                                                trans('message.Job Card No') }}
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                                                ...
                                                <input type="text" id="in_date" name="in_date"
                                                    value="<?php echo date(getDateFormat() . ' H:i:s', strtotime($services->service_date)); ?> "
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <label
                                                class="jobcardmargintop col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">{{
                                                trans('message.KMS Run') }}:
                                                <label class="color-danger">*</label></label>
                                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                ...
                                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 space1">
                                    <p
                                        class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 space1_solid">
                                    </p>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                            ...
                                            <span id="common_error_span" class="help-block error-help-block text-danger"
                                                style="display: none">{{ trans('message.Please Select Assign
                                                To.')}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        <h2 class="text-left jobcard_heading fw-bold">{{ trans('message.Customer
                                            Details') }}
                                        </h2>
                                        <p
                                            class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 space1_solid">
                                        ...
                                        <div class="row mt-3">
                                            <label
                                                class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">{{
                                                trans('message.Contact No') }}:</label>
                                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 vehicle_space">
                                        <h2 class="text-left jobcard_heading fw-bold">{{ trans('message.Vehicle
                                            Details') }}
                                        </h2>
                                        <p
                                            class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 space1_solid">
                                        ...
                                        <div class="row mt-3">
                                            <label
                                                class="control-label col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                                trans('message.Model Name') }}:</label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                                <input type="text" id="model" name="model" class="form-control"
                                                    value="{{ $vehicale->modelname }}" readonly>
                                            </div>
                                            <label
                                                class="jobcardmargintop col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                                trans('message.Chasis No') }}:
                                            </label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                                <input type="text" id="chassisno" name="chassisno" class="form-control"
                                                    value="{{ $vehicale->chassisno }}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <label
                                                class="jobcardmargintop control-label col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                                trans('message.Engine No') }}:
                                            </label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                                <input type="text" id="engine_no" name="engine_no" class="form-control"
                                                    value="{{ $vehicale->engineno }}" readonly>
                                            </div>
                                        ...
                                        <div class="row mt-3 divId" id="divId">
                                            <label
                                                class="control-label col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                                trans('message.Date Of Sale') }}:
                                            </label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                                <input type="text" id="sales_date" name="sales_date"
                                                    class="form-control"
                                                    value="{{ date(getDateFormat(), strtotime($s_date->date)) }}"
                                                    readonly>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <label class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                        ...
                                        <div class="row mt-3">
                                            <label class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{
                                                trans('message.Wash Bay Charge') }}<label
                                                    class="text-danger"></label>:</label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                                <input type="text" id="washBay" name="washBayCharge"
                                                    class="form-control" value="{{ $washbay_data->price }}" readonly>
                                            </div>
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-10 col-lg-10 col-xl-10 col-xxl-10 col-sm-10 col-xs-10">
                                        <h3 class="fw-bold mt-0">{{ trans('message.Observation List') }}
                                            <button type="button" data-bs-target="#responsive-modal-observation"
                                                ...
                                                class="btn btn-outline-secondary clickAddNewButton ms-1"> + </button>
                                        </h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-bs-toggle="collapse" href="#collapse1" class="ob_plus"><i
                                                        class="fa fa-plus"></i>
                                        ...
                                        <div id="collapse1" class="panel-collapse collapse in">
                                            <div class="panel-body main_data table-responsive">
                                                ...
                                                <table class="table table-bordered table-sm main_data_points f-14"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="fw-bold" style="width:10%;">{{
                                                                trans('message.Service Charge') }}</th>
                                ...
                                <div class="col-md-10 col-lg-10 col-xl-10 col-xxl-10 col-sm-10 col-xs-10">
                                    <h2 class="fw-bold mt-0">{{ trans('message.Other Product Service Charges') }}
                                        <button type="button" id="add_new_product"
                                            class="btn btn-outline-secondary mt-0 ms-1"
                                            url="{!! url('/jobcard/addproducts') !!}"> + </button>
                                    </h2>
                                </div>
                                                ...
                                                <tr id="<?php echo 'row_id_' . $id; ?>">
                                                    <td>
                                                        <input type="text" name="other_product[]"
                                                            class="form-control othr_prod_<?php echo $id; ?>"
                                                            value="<?php echo $product->comment; ?>"
                                                            id="othr_prod_<?php echo $id; ?>"
                                                            othr_prod="<?php echo $product->id; ?>" maxlength="250">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="other_price[]"
                                                            class="form-control other_service_price othr_price_<?php echo $id; ?>"
                                                            id="oth_price" value="<?php echo $product->total_price; ?>"
                                                            maxlength="8"
                                                            onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="trash_product" style="cursor: pointer;"
                                                            data-id="<?php echo $id; ?>"><i class="fa fa-trash fa-2x"
                                                                aria-hidden="true"></i>
                                                        </span>
                                                    </td>
                                                </tr>
                                ...
                                <div class="col-md-10 col-lg-10 col-xl-10 col-xxl-10 col-sm-10 col-xs-10">
                                    <h2 class="fw-bold mt-0">{{ trans('message.Other Service Charges') }}
                                        <button type="button" id="add_new_service"
                                            class="btn btn-outline-secondary mt-0 ms-1"
                                            url="{!! url('/jobcard/addService') !!}"> + </button>
                                    </h2>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered addtaxtype" id="tab_services_detail"
                                            align="center">
                                            <thead>
                                                <tr>
                                                ...
                                                <tr id="<?php echo 'row_service_id_' . $id; ?>">
                                                    <td>
                                                        <input type="text" name="other_service_name[]"
                                                            class="form-control other_service_name<?php echo $id; ?>"
                                                            value="<?php echo $service?->name; ?>"
                                                            id="other_service_name<?php echo $id; ?>"
                                                            other_service_name="<?php echo $service->id; ?>"
                                                            maxlength="250">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="other_short_desc[]"
                                                            class="form-control other_short_desc other_service_description<?php echo $id; ?>"
                                                            value="<?php echo $service?->short_description; ?>"
                                                            id="other_short_desc_<?php echo $id; ?>" maxlength="250">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="other_service_cylinder[]"
                                                            class="form-control other_service_cylinder_<?php echo $id; ?>"
                                                            value="<?php echo $service?->cylinder; ?>"
                                                            id="othr_service_cylinder_<?php echo $id; ?>"
                                                            maxlength="250">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="other_service_price[]"
                                                            class="form-control other_service_price other_service_price_<?php echo $id; ?>"
                                                            id="oth_service_price"
                                                            value="<?php echo $service->price; ?>" maxlength="8"
                                                            onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="trash_service" style="cursor: pointer;"
                                                            data-id="<?php echo $id; ?>"><i class="fa fa-trash fa-2x"
                                                                aria-hidden="true"></i>
                                                        </span>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-danger initiateProcessBtn border-0 text-light"
                                                            id="initiateProcessButton"
                                                            url_init_process="{{ url('/jobcard/get_initial_process_status') }}">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-danger initiateProcessBtn border-0 text-light"
                                                            disabled="true">{{ trans('message.Initiate Process')
                                                            }}</button>
                                                        @endif

                                                        @if ($washbay_data->initiate_status == 1)
                                                        <button type="button" class="btn btn-success completeProcess"
                                                            id="completeProcessBtn"
                                                            url_complete_process="{{ url('/jobcard/complete_process_status') }}">
                                                        ...
                                                        <input type="checkbox" name="notifyCustomer"
                                                            class="text-right notifyCustomerCheckbox" id="" checked>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @endforeach
                                                    @else
                                                    <h6 class="text-center">{{ trans('message.No Observation Points
                                                        Available For This Vehicle Model') }}</h6>
                                                    @endif
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button"
                                                        class="btn btn-success col-md-offset-10 check_submit observationPointModelSubmitButton"
                                                        style="margin-bottom:5px;" disabled="true">{{
                                                        trans('message.Submit') }}</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-1 mx-0">
                                        <button type="submit" class="btn btn-success addJobcardSubmitButton">{{
                                            trans('message.SUBMIT') }}</button>
                                    </div>
                                </div>
                        </div>
