          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $gatepasss->id }}">
                ...
                @endcan
                <td><a data-bs-toggle="modal" data-bs-target="#myModal-gateview" serviceid="" class="getgetpass" getpassid="{{ $gatepasss->jobcard_id }}">{{ $gatepasss->gatepass_no }} <a data-toggle="tooltip" data-placement="bottom" title="Gatepass No." class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                <td><a data-bs-toggle="modal" data-bs-target="#myModal-gateview" serviceid="" class="getgetpass" getpassid="{{ $gatepasss->jobcard_id }}">{{ $gatepasss->jobcard_id }} <a data-toggle="tooltip" data-placement="bottom" title="Job No." class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                <td>{{ getCustomerName($gatepasss->customer_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td><a data-bs-toggle="modal" data-bs-target="#myModal-gateview" serviceid="" class="getgetpass" getpassid="{{ $gatepasss->jobcard_id }}">{{ getVehicleName($gatepasss->vehicle_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Vehicle Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                <td>
