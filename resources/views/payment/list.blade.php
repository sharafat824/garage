          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $payment_method->id }}">
                ...
                <td><a href="{!! url('/payment/list/edit/' . $payment_method->id) !!}">{{ $payment_method->payment }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Payment Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                ...
                <td>
                  <div class="dropdown_toggle">
                    ...
                    <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                      ...
                      <li><a class="dropdown-item sa-warning" url="{!! url('/payment/list/delete/' . $payment_method->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                      @endcan
                    </ul>
                  </div>
                </td>
