        ...
        <div class="page-title">
            <div class="nav_menu">
                <nav>
                    ...
                    <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('setting/accessrights/show') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}"></i><span class="titleup">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="business_hours_edit_form" method="post" action="{{ url('setting/holiday/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
                            ...
                            <div class="row mt-3 {{ $errors->has('adddate') ? ' has-error' : 'Date inst' }}">
                            ...
                            <div class="row mt-3 businessTitleMainDiv">
                            ...
                            <div class="row mt-3 businessDescriptionMainDiv">
