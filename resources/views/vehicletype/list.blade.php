          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $vehicaltypess->id }}">
                ...
                @endcan
                <td><a href="{!! url('/vehicletype/list/edit/' . $vehicaltypess->id) !!}">{{ $vehicaltypess->vehicle_type }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Vehicle Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></td>
