                    ...
                    <table id="supplier" class="table jambo_table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr data-user-id="{{ $expenses->id }}">
                                ...
                                <td><a href="{!! url('/expense/edit/' . $expenses->tbl_expenses_id) !!}">{{ $expenses->main_label }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Expense Label" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>

                                <td>{{ getSumOfExpense($expenses->tbl_expenses_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Expense Amount( <?php echo getCurrencySymbols(); ?> )" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                                ...
                                <td>{{ date(getDateFormat(), strtotime($expenses->date)) }} <a data-toggle="tooltip" data-placement="bottom" title="Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
