      ...
      <div class="nav_menu">
        <nav>
          ...
          <span class="titleup">{{ trans('message.Vehicle Brand') }}
              ...
              <a href="{!! url('/vehiclebrand/add') !!}" id="">
        ...
        <div class="x_panel">
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              @endcan
                <td><a href="{!! url('/vehiclebrand/list/edit/' . $vehicalbrands->id) !!}">{{ getVehicleBrand($vehicalbrands->vehicle_id) }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Vehicle Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></td>
                <td><a href="{!! url('/vehiclebrand/list/edit/' . $vehicalbrands->id) !!}">{{ $vehicalbrands->vehicle_brand }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Vehicle Brand" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></td>
                ...
                <td>
                  <div class="dropdown_toggle">
                    ...
                    <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                      ...
                      <li><a class="dropdown-item sa-warning" url="{!! url('/vehiclebrand/list/delete/' . $vehicalbrands->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                      @endcan
                    </ul>
                  </div>
                </td>
