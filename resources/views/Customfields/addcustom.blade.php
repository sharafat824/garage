                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            <form id="customFieldAddForm" method="post" action="{{ url('setting/custom/store') }}" enctype="multipart/form-data" class="form-horizontal upperform customAddForm">
                                ...
                                <div class="row mt-0 has-feedback">
                                ...
                                <div class="row radio_add_part_div" style="display: none;">
                                ...
                                <div class="row col-md-6 col-sm-6 col-xs-12 form-group radio_label_view_part_div" style="display: none;">
                                ...
                                <div class="row checkbox_add_part_div" style="display: none;">
                                ...
                                <div class="row col-md-6 col-sm-6 col-xs-12  form-group checkbox_label_view_part_div" style="display: none;">
                                ...
                                <div class="row has-feedback">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 required">
                                    ...
                                    <div class="row mt-3 has-feedback">
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 visible mx-1">
