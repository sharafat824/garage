          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $products->id }}"> 
                ...
                @endcan
                <td><a href="{!! url('/product/list/edit/' . $products->id) !!}"><img src="{{ URL::asset('public/product/' . $products->product_image) }}" width="52px" height="52px" class="datatable_img"></a></td>

                <td><a href="{!! url('/product/list/edit/' . $products->id) !!}">{{ $products->product_no }}&nbsp;
