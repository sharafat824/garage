        ...
        <div class="x_content">
          <form id="productEdit-Form" method="post" action="update/{{ $product->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 addremove">
                  <button type="button" data-bs-target="#responsive-modal-unit" data-bs-toggle="modal" class="btn btn-outline-secondary btn-sm">{{ trans('message.Add/Remove') }}</button>
                </div>
              </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 form-group data_popup">
                        <button type="button" class="btn btn-success addtype model_submit" producturl="{!! url('/product_type_add') !!}">{{ trans('message.Submit') }}</button>
                      </div>
                    </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2 form-group data_popup ml-3">
                          <button type="button" class="btn btn-success addunit model_submit" uniturl="{!! url('product/unit') !!}">{{ trans('message.Submit') }}</button>
                        </div>
                      </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.addtype').click(function() {
        ...
        var msg21 = "{{ trans('message.Please enter product type') }}";
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              if (data == '01') {
                ...
                $('.producttype').append('<tr class=" row mx-1 ' + classname +
                  ' data_of_type"><td class="text-start col-6">' + product_type +
                  '</td><td class="text-end col-6"><button type="button" id=' + data +
                  ' deletecolor="{!! url('colortypedelete') !!}" class="btn btn-danger text-white border-0 deletecolors"><i class="fa fa-trash" aria-hidden="true"></i></button></a></td><tr>'
                );
      ...
      $('.addunit').click(function() {
        ...
        } else if (!call_var_unit_measurementadd.unit_measurement_pattern.test(call_var_unit_measurementadd
        ...
        } else if (!call_var_unit_measurementadd.unit_measurement_pattern2.test(call_var_unit_measurementadd
            .unit_measurement_value)) {
          $('.u_name').val("");
          swal({
            title: msg34,
            ...
            success: function(data) {
              ...
              if (data == '01') {
                ...
                $('.unitproductname').append('<tr class=" row mx-1 ' + deleteclass +
                  ' data_unit_name"><td class="text-start">' + unit_measurement +
                  '</td><td class="text-end"><button type="button" unitid=' + data +
                ...
                $('.unit_product_data').append('<option value=' + data + '>' + unit_measurement +
                  '</option>');
                $('.u_name').val('');
              }
            },
      ...
      $('body').on('click', '.updateProductButton', function(e) {
        $('#productEdit-Form input, #productEdit-Form select, #productEdit-Form textarea').each(
          ...
          function(index) {
            ...
            if (input.attr('name') == "p_date" || input.attr('name') == "name" || input.attr('name') ==
