  ...
  <table border="0" class="adddatatable mt-2">
    <tbody>
      <tr>
        ...
        <td width="20%" class="small-font">
          <div class="col-xl-6 col-md-6 col-sm-12 mt-4 mb-3">
            <label class="fw-bold">{{ trans('message.Purchase Number :') }} </label>
            <label class=""> <?php echo $purchas->purchase_no; ?> </label>
          </div>
          <div class="col-xl-6 col-md-6 col-sm-12 mt-2 mb-3">
  ...
  <table class="table" width="100%">
    <tbody>
      ...
      <tr class="small-screen">
        ...
        <td class="text-right fw-bold cname gst text-light"><?php echo $total; ?></td>
      </tr>
    </tbody>
  </table>
</div>
