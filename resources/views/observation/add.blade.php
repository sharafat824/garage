                ...
                <div class="x_content">
                    ...
                    <div class="x_panel">
                        ...
                        <form id="form_add" action="{{ url('/observation/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left observationAddForm">
                            ...
                            <div class="row {{ $errors->has('veh_name') ? ' has-error' : '' }}">
                            ...
                            <div class="row mt-3 {{ $errors->has('checkpoint_name1') ? ' has-error' : '' }}">
                            ...
                            <div class="row mt-3 parentClass_1 {{ $errors->has('checkpoint') ? ' has-error' : '' }}">
