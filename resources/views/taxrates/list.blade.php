          ...
          <table id="supplier" class="table  jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $accounts->id }}">
                ...
                @endcan
                <td><a href="{!! url('/taxrates/list/edit/' . $accounts->id) !!}">{{ $accounts->taxname }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Account Tax Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $accounts->tax }} <a data-toggle="tooltip" data-placement="bottom" title="Tax Rates(%)" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $accounts->tax_number }} <a data-toggle="tooltip" data-placement="bottom" title="Tax Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
