          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $colors->id }}">
                ...
                @endcan
                <td><a href="{!! url('/color/list/edit/' . $colors->id) !!}">{{ $colors->color }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Color Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></td>
                ...
                <td>
                  <div class="dropdown_toggle">
                    ...
                    <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li><a class="dropdown-item sa-warning" url="{!! url('/color/list/delete/' . $colors->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                      @endcan
                    </ul>
                  </div>
                </td>
