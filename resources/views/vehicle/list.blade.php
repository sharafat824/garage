          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              @endcan
                ...
                <td><a href="{!! url('/vehicle/list/view/' . $vehicals->id) !!}">{{ $vehicals->modelname }}</a><a data-toggle="tooltip" data-placement="bottom" title="Model Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ getVehicleType($vehicals->vehicletype_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                ...
                <td>{{ $vehicals->engineno ?? trans('message.Not Added') }} <a data-toggle="tooltip" data-placement="bottom" title="Engine No" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $vehicals->number_plate ?? trans('message.Not Added') }} <a data-toggle="tooltip" data-placement="bottom" title="Number Plate" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                @can('customer_view')
                <td>
                  <a href="{!! url('/customer/list/' . $vehicals->customer_id) !!}"> {{ getCustomerName($vehicals->customer_id) ?? trans('message.Not Added')}} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a>
                </td>
                @else
                <td>
                  {{ getCustomerName($vehicals->customer_id) ?? trans('message.Not Added')}} <a data-toggle="tooltip" data-placement="bottom" title="Customer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
                </td>
                @endcan 
                <td>
