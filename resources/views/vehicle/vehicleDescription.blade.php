                ...
                <div class="nav_menu">
                    <nav>
                        <div class="nav toggle">
                            <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup"><a href="{{ URL::previous() }}"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="me-2"></a>{{ $vehical->modelname }}</span>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-xl-12 col-md-12 col-sm-12">
                        <ul class="nav nav-tabs" role="tablist">
                            @can('vehicle_view') 
                            <li class="">
                                <a href="{!! url('vehicle/list/view/' . $vehical->id) !!}" class="tab fw-bold">
                                    {{ trans('message.BASIC DETAILS') }}</a>
                            </li>
                            @endcan
                            @can('vehicle_view') 
                            <li class="active">
                                <a href="{!! url('vehicle/list/view/description/' . $vehical->id) !!}" class="tab fw-bold">
                                    {{ trans('message.DESCRIPTION') }}</a>
                            </li>
                            @endcan 
                            @can('service_view') 
                            <li class="">
                                <a href="{!! url('vehicle/list/view/maintainance/' . $vehical->id) !!}" class="tab fw-bold">
                                    {{ trans('message.MAINTAINANCE HISTORY') }}</a>
                            </li>
                            @endcan
                            @can('service_view') 
                            <li class="">
                                <a href="{!! url('vehicle/list/view/MOT/' . $vehical->id) !!}" class="tab fw-bold">
