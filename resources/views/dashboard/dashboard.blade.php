    ...
    <div class="x_panel mb-0">
        ...
        <div class="row mainRowDiv" isHide="1" isArabic="<?php if (getValue() == 'rtl') {
            ...
            <div class="shadow p-3 pb-0 border" id="setup_wizard" style="width: 98%;margin-left: 10px;">
                <div class="row">
                    <div class="col">
                        <span class="titleup mt-2">{{ trans('Setup Wizard') }} </span>
                    </div>
                ...
                @endif
                    ...
                    <a href="setting/general_setting/list" target="">
                        <div class="steps step step-one greenCircle step-oneGreen customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/setting.png') }}" alt="Avatar" class="main-image">
                    ...
                    @else
                    <a href="setting/general_setting/list" target="">
                        <div class="steps step step-one blueCircle step-oneBlue customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/setting.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="customer/list" target="">
                        <div class="steps step a-step-one greenCircle step-oneGreen customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/users.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="customer/add" target="">
                        <div class="steps step a-step-one blueCircle step-oneBlue customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/users.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="employee/list" target="">
                        <div class="steps step a-step-two greenCircle step-twoGreen employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/employee.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="employee/add" target="">
                        <div class="steps step a-step-two blueCircle step-twoBlue employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/employee.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="supplier/list" target="">
                        <div class="steps step a-step-four greenCircle step-fourGreen supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/supplier.png') }}" alt="Avatar" class="main-image">
                            <span class="name-text_green">{{ trans('message.Supplier') }}</span>
                            <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                        </div>
                    </a>
                    @else
                    <a href="supplier/add" target="">
                        <div class="steps step a-step-four blueCircle step-fourBlue supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/supplier.png') }}" alt="Avatar" class="main-image">
                            <span class="name-text_blue">{{ trans('message.Supplier') }}</span>
                            <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                        </div>
                    </a>
                    @endif
                    ...
                    <a href="vehicle/list" target="">
                        <div class="steps step a-step-five greenCircle step-fiveGreen vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/vehicle.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="vehicle/add" target="">
                        <div class="steps step a-step-five blueCircle step-fiveBlue vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/vehicle.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="product/list" target="">
                        <div class="steps step a-step-six greenCircle step-sixGreen product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/product.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="product/add" target="">
                        <div class="steps step a-step-six blueCircle step-sixBlue product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/product.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="purchase/list" target="">
                        <div class="steps step a-step-seven greenCircle step-sevenGreen purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/purchase.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="purchase/add" target="">
                        <div class="steps step a-step-seven blueCircle step-sevenBlue purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/purchase.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="observation/list" target="">
                        <div class="steps step a-step-eight greenCircle step-eightGreen observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/observation.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="observation/add" target="">
                        <div class="steps step a-step-eight blueCircle step-eightBlue observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/observation.png') }}" alt="Avatar" class="main-image">
                    ...
                    <a href="jobcard/list" target="">
                        <div class="steps step step-nine greenCircle step-nineGreen observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/service.png') }}" alt="Avatar" class="main-image">
                            <span class="name-text_green">{{ trans('Job Card') }}</span>
                            <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                        </div>
                    </a>
                    @else
                    <a href="service/add" target="">
                        <div class="steps step step-nine blueCircle step-nineBlue observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/service.png') }}" alt="Avatar" class="main-image">
                            <span class="name-text_blue">{{ trans('Job Card') }}</span>
                            <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                        </div>
                    </a>
                    @endif
                ...
                <div class="shadow p-3 pb-0 border" id="setup_wizard" style="width: 98%;margin-left: 10px;">
                    ...
                    <hr>
                        ...
                        @if ($Customer != 0)
                        <a href="customer/list" target="">
                            <div class="steps step step-two greenCircle step-twoGreen supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/users.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Customers') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else 
                        <a href="customer/add" target="">
                            <div class="steps step step-two blueCircle step-twoBlue supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/users.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Customers') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        ...
                        @if ($employee != 0)
                        <a href="employee/list" target="">
                            <div class="steps step step-three greenCircle step-threeGreen employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/employee.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Employees') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else
                        <a href="employee/add" target="">
                            <div class="steps step step-three blueCircle step-threeBlue employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/employee.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Employees') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        ...
                        @if ($Supplier != 0)
                        <a href="supplier/list" target="">
                            <div class="steps step step-four greenCircle step-fourGreen supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/supplier.png') }}" alt="Avatar" class="main-image">
                        ...
                        @else
                        <a href="supplier/add" target="">
                            <div class="steps step step-four blueCircle step-fourBlue supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/supplier.png') }}" alt="Avatar" class="main-image">
                        ...
                        @if ($have_vehicle != 0)
                        <a href="vehicle/list" target="">
                            <div class="steps step step-five greenCircle step-fiveGreen vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/vehicle.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Vehicles') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else
                        <a href="vehicle/add" target="">
                            <div class="steps step step-five blueCircle step-fiveBlue vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/vehicle.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Vehicles') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        ...
                        @if ($have_product != 0)
                        <a href="product/list" target="">
                            <div class="steps step step-six greenCircle step-sixGreen product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/product.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Products') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else
                        <a href="product/add" target="">
                            <div class="steps step step-six blueCircle step-sixBlue product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/product.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Products') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        ...
                        @if ($have_purchase != 0)
                        <a href="purchase/list" target="">
                            <div class="steps step step-seven greenCircle step-sevenGreen purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/purchase.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Purchase') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else
                        <a href="purchase/add" target="">
                            <div class="steps step step-seven blueCircle step-sevenBlue purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/purchase.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Purchase') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        ...
                        @if ($have_observationCount != 0)
                        <a href="observation/list" target="">
                            <div class="steps step step-eight greenCircle step-eightGreen observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/observation.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_green">{{ trans('message.Observation Library') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
                        @else
                        <a href="observation/add" target="">
                            <div class="steps step step-eight blueCircle step-eightBlue observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/observation.png') }}" alt="Avatar" class="main-image">
                                <span class="name-text_blue">{{ trans('message.Observation Library') }}</span>
                                <img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png') }}" alt="Avatar" class="imgs">
                            </div>
                        </a>
