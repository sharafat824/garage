...
<div class="step-content">
  <div class="error-message">
    ...
    <label class="text-danger error-message-line">
      {{ trans('message.This purchase key is already registered with the different domain. If you have any issue please contact us at sales@dasinfomedia.com') }}
    </label>
    @elseif(session('message') == '3')
    <label class="text-danger error-message-line">
      {{ trans('message.There seems to be some problem please try after sometime or contact us on sales@dasinfomedia.com') }}
    </label>
    @elseif(session('message') == '4')
    <label class="text-danger error-message-line">
      {{ trans('message.Please enter correct purchase key for this plugin.') }} </label>
