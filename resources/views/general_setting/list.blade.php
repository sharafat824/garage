          ...
          <div class="x_content">
            <form id="general_setting_edit_form" method="post" action="{{ url('setting/general_setting/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
              ...
              <div class="row mt-3 has-feedback">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                  <select class="form-control select_country_name form-select" name="country_id" countryurl="{!! url('/getstatefromcountry') !!}" required>
              ...
              <div class="row mt-3 has-feedback">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                  <select class="form-control state_of_country_name form-select" name="state_id" stateurl="{!! url('/getcityfromstate') !!}">
              ...
              <div class="row mt-3 has-feedback">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                  <select class="form-control city_of_state_name form-select" name="city">
