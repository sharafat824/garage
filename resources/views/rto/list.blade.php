          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-user-id="{{ $rtos->id }}">
                ...
                <td><a href="{{ url('rto/list/edit/' . $rtos->id) }}">{{ getVehicleName($rtos->vehicle_id) }}</a> <a data-toggle="tooltip" data-placement="bottom" title="Vehicle Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $rtos->registration_tax }} <a data-toggle="tooltip" data-placement="bottom" title="RTO / Registration C.R. Temp Tax" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $rtos->number_plate_charge }} <a data-toggle="tooltip" data-placement="bottom" title="Number Plate charge" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                <td>{{ $rtos->muncipal_road_tax }} <a data-toggle="tooltip" data-placement="bottom" title="Municipal Road Tax" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
