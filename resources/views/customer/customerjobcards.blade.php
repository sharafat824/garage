            ...
            <div class="row mt-4">
                <div class="col-xl-12 col-md-12 col-sm-12 pt-3">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        @can('vehicle_view')
                        <li class="">
                            <a href="{!! url('/customer/list/vehicle/' . $customer->id) !!}" class="tab fw-bold">
                                {{ trans('message.VEHICLE DETAILS') }}</a>
                        </li>
                        @endcan
                        @can('jobcard_view')
                        <li class="active">
                            <a href="{!! url('/customer/list/jobcard/' . $customer->id) !!}" class="tab fw-bold">
                                {{ trans('message.JOB CARDS') }}</a>
                        </li>
                        @endcan
                        @can('quotation_view')
                        <li class="">
                            <a href="{!! url('/customer/list/quotation/' . $customer->id) !!}" class="tab fw-bold">
                                {{ trans('message.QUOTATIONS') }}</a>
                        </li>
                        @endcan
                        @can('invoice_view')
                        <li class="">
                            <a href="{!! url('/customer/list/invoice/' . $customer->id) !!}" class="tab fw-bold">
                                {{ trans('message.INVOICES') }}</a>
                        </li>
                        @endcan
                        <li class="">
                            <a href="{!! url('/customer/list/payment/' . $customer->id) !!}" class="tab fw-bold">
