      ...
      <ul class="nav nav-tabs bar_tabs"
        ...
        @can('customer_view')
          <li role="presentation"
            class=""><a href="{!! url('/customer/list') !!}"><span class="visible-xs"></span><i
      ...
      <div class="x_content">
        <form id="demo-form2" action="update/{{ $customer->id }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
          ...
          <div class="row">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-form-group">
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                ...
                <input type="text" id="datepicker" autocomplete="off" class="form-control datepicker" placeholder="<?php echo getDateFormat(); ?>" value="{{ date(getDateFormat(), strtotime($customer->birth_date)) }}" name="dob" onkeypress="return false;" />
                @else
                <input type="text" id="datepicker" autocomplete="off" class="form-control datepicker" placeholder="<?php echo getDateFormat(); ?>" value="" name="dob" onkeypress="return false;" />
                @endif
              </div>
            </div>
          </div>
