        ...
        <nav>
          <div class="nav toggle">
              ...
              <a href="{!! url('/customer/add') !!}" id="">
                <img src="{{ URL::asset('public/img/icons/plus Button.png') }}" alt="add customer">
              </a>
            </span>
          </div>
    ...
    <table id="supplier" class="table responsive jumbo_table" style="width:100%">
      ...
      <tbody>
        ...
        <tr data-user-id="{{ $customers->id }}">
          ...
          <td><a href="{!! url('/customer/list/' . $customers->id) !!}">{{ $customers->name .' '.$customers->lastname}} </a><a data-toggle="tooltip" data-placement="bottom" title="First Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
          <td>{{ $customers->mobile_no }} <a data-toggle="tooltip" data-placement="bottom" title="Mobile Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
          <td>
            <pre>{{ getVehicles($customers->id) }} <a data-toggle="tooltip" data-placement="bottom" title="Vehicle List" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></pre>
          </td>
          <td>
