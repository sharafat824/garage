                ...
                <table id="supplier" class="table jambo_table " style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a type="button" data-bs-toggle="modal" data-bs-target="#stockview" stockid="{{ $stocks->id }}" url="{!! url('/stoke/list/stockview') !!}" class=" stocksave">{{ $stocks->product_no }} </a> <a data-toggle="tooltip" data-placement="bottom" title="Product Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ getProductName($stocks->product_type_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Manufacturer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ getProduct($stocks->product_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Product Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ getStockCurrent($stocks->product_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Quantity" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ getUnitMeasurement($stocks->product_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Unit Of Measurement" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>
