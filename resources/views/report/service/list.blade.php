            ...
            <div class="x_panel table_up_div">
                <table id="supplier" class="table jambo_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i }}</td>
                            <td>{{ $servicereports->job_no }} <a data-toggle="tooltip" data-placement="bottom" title="Job No." class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            ...
                            <td>{{ ucfirst($servicereports->service_type) }} <a data-toggle="tooltip" data-placement="bottom" title="Service Type" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ number_format(getPaidAmount($servicereports->job_no), 2) }} <a data-toggle="tooltip" data-placement="bottom" title="Paid Amount( <?php echo getCurrencySymbols(); ?> )" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
