            ...
            <div class="x_panel table_up_div">
                <table id="supplier" class="table jambo_table" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i }}</td>
                            <td><a data-bs-toggle="modal" data-bs-target="#stockview" productid="{{ $productreports->product_id }}" s_date="{{ $s_date }}" e_date="{{ $e_date }}" url="{!! url('/report/stock/modalviewPart') !!}" class="stocksave">{{ $productreports->product_no }} <a data-toggle="tooltip" data-placement="bottom" title="Product Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></a></td>
                            <td>{{ getProductName($productreports->product_type_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Manufacturer Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ $productreports->name }} <a data-toggle="tooltip" data-placement="bottom" title="Product Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            <td>{{ getTotalProduct($productreports->id, $s_date, $e_date) }} <a data-toggle="tooltip" data-placement="bottom" title="Total Stock" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            @if ($productreports->category == 0)
                            <td>{{ getCellProduct($productreports->id, $s_date, $e_date) }} <a data-toggle="tooltip" data-placement="bottom" title="Product Sales" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            @else
                            <td>{{ getCellProductSale($productreports->id, $s_date, $e_date) }} <a data-toggle="tooltip" data-placement="bottom" title="Product Sales" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            @endif
                            @if ($productreports->category != 0)
                            <td>{{ getTotalServiceProduct($productreports->id, $s_date, $e_date) }} <a data-toggle="tooltip" data-placement="bottom" title="Product Service" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            @else
                            <td>0 <a data-toggle="tooltip" data-placement="bottom" title="First Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
                            @endif
                            @if ($productreports->category == 0)
                            @can('report_view')
