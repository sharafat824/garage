            ...
            <tr>
              ...
              <td>
                <a href="{!! url('/purchase/list/pview/' . $productreports->purchase_id) !!}">
                  {{ getLatestPurchaseCode($productreports->product_id) }} <a data-toggle="tooltip" data-placement="bottom" title="Purchase Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
                </a>
              </td>

              <td>
                <a href="{!! url('/product/list/' . $productreports->id) !!}">
                  {{ $productreports->product_no }} <a data-toggle="tooltip" data-placement="bottom" title="Product Number" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a>
                </a>
              </td>
              ...
              <td>{{ date(getDateFormat(), strtotime(getLatestPurchaseDate($productreports->product_id))) }} <a data-toggle="tooltip" data-placement="bottom" title="Purchase Date" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ getSupplierName(getPurchaseSupplier($productreports->purchase_id)) }} <a data-toggle="tooltip" data-placement="bottom" title="Supplier Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ $productreports->price }} <a data-toggle="tooltip" data-placement="bottom" title="Price( <?php echo getCurrencySymbols(); ?> )" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
              <td>{{ getTotalStock($productreports->id) }} <a data-toggle="tooltip" data-placement="bottom" title="Stock" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
            </tr>
            <?php $i++; ?>
            @endforeach
            @endif
