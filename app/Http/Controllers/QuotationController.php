...
class QuotationController extends Controller
{
	...
	public function quotationView(Request $request)
	{
		...
		$html = view('quotation.quotationmodel')->with(compact('service_id', 'logo', 'custo_info', 'vehi_name', 'regi', 'all_data', 'all_data2', 'used_cpn_data', 'service_data', 'service_taxes', 'tbl_custom_fields', 'washbay_data'))->render();
