...
class EmployeeAddEditFormRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'email.email'  => trans('message.Please enter a valid email address. Like : sales@dasinfomedia.com'),
            'email.unique' => trans('message.Email you entered is already registered.'),
            'email.custom_email' => trans('message.Please enter a valid email address. Like : sales@dasinfomedia.com'),
            ...
            'join_date.required' => trans('message.Join date is required.'),

            'designation.required' => trans('message.Designation is required.'),
            'designation.regex'  => trans('message.Designation is only alphabets and space.'),
            'designation.max' => trans('message.Designation should not more than 50 character.'),
